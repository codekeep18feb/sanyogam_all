...
export default function VideoWindow({ with_email,with_userid }) {
  ...
  const fetchRTCUserInfo = async () => {
    ...
    try {
      const response = await fetch(`http://107.22.47.202:8000/api/rtc_user_info_by_id/${with_userid}`, {
        method: 'GET',
        headers: {
  ...
  const addRTCUserInfo = async (isInitiator, sdp,to_user) => {
    ...
    try { 
      const response = await fetch(`http://107.22.47.202:8000/api/add_rtc_user`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': token,
  ...
  const fetchUserId = async (token,with_email)=>{
    ...
    // http://107.22.47.202:8000/api/users/query?q_email=deepaksingh.18feb%40gmail.com
    try {
      const response = await fetch(`http://107.22.47.202:8000/api/users/query?q_email=${with_email}`, {
        method: 'GET',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': token,
  ...
  useEffect(async() => {
    ...
    const fetchChatHistory = async () => {
      ...
      try {
        const response = await fetch(`http://107.22.47.202:8000/api/chathistory/${with_email}`, {
          method: 'GET',
          headers: {
            'Content-Type': 'application/json',
            'Authorization': token,
    ...
    const fetchRequestStatus = async () => {
      ...
      try {
        const response = await fetch(`http://107.22.47.202:8000/api/request_info/${with_email}`, {
          method: 'GET',
          headers: {
            'Content-Type': 'application/json',
            'Authorization': token,
