...
export default function ChatWindow({ with_email,with_userid }) {
  ...
  const fetchRTCUserInfo = async () => {
    ...
    try {
      const response = await fetch(`http://192.168.1.5:8000/api/rtc_user_info_by_id/${with_userid}`, {
        method: 'GET',
        headers: {
  ...
  const fetchRTCOffer = async () => {
    ...
    try {
      const response = await fetch(`http://192.168.1.5:8000/api/get_my_rtc_offer`, {
        method: 'GET',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': token,
  ...
  const fetchUserId = async (token,with_email)=>{
    ...
    try {
      const response = await fetch(`http://192.168.1.5:8000/api/users/query?q_email=${with_email}`, {
        method: 'GET',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': token,
  ...
  useEffect(async () => {
    const fetchChatHistory = async () => {
      ...
      try {
        const response = await fetch(`http://192.168.1.5:8000/api/chathistory/${with_email}`, {
          method: 'GET',
          headers: {
            'Content-Type': 'application/json',
            'Authorization': token,
    ...
    const fetchRequestStatus = async () => {
      ...
      try {
        const response = await fetch(`http://192.168.1.5:8000/api/request_info/${with_email}`, {
          method: 'GET',
          headers: {
            'Content-Type': 'application/json',
            'Authorization': token,
