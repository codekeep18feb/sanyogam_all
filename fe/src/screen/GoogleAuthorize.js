...
export function GoogleAuthorize({ login }) {
  ...
  const GOOGLE_REDIRECT_URI = "http://192.168.1.9:3000/google_authorized";
  ...
  const handlePasswordSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(
        "http://192.168.1.9:8000/api/save_user_detail",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
      ...
      if (response.status === 201) {
        ...
        try {
          ...
          if (response.status === 201) {
            ...
            if (data) {
              const response = await fetch("http://192.168.1.9:8000/api/me", {
                method: "GET",
                headers: {
                  "Content-Type": "application/json",
          ...
          // const response2 = await fetch('http://192.168.1.9:8000/api/profiles', {
          //   method: 'GET',
          //   headers: {
          //     'Content-Type': 'application/json',
          //   },
