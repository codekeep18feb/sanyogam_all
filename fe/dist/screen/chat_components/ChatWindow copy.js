...
var _ChatScreenWithInfo = _interopRequireDefault(require("./ChatScreenWithInfo"));
...
function ChatWindow(_ref) {
  ...
  (0, _react.useEffect)(async () => {
    ...
    const fetchRequestStatus = async () => {
      ...
      try {
        ...
        const response = await fetch("http://127.0.0.1:8000/api/handle_request?to_email=".concat(with_email), {
          method: "GET",
          headers: {
            "Content-Type": "application/json",
            Authorization: token
  ...
  }, requestStatus ? /*#__PURE__*/_react.default.createElement(_ChatScreenWithInfo.default, {
