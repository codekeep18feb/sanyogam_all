...
exports.default = WrapperMobileBackShellWithSave;
...
var _HeaderMobileBack = _interopRequireDefault(require("./HeaderMobileBack"));
...
function WrapperMobileBackShellWithSave(_ref) {
  let {
    children,
    title,
    onSave
  ...
  }, /*#__PURE__*/_react.default.createElement(_HeaderMobileBack.default, {
    title: title
  })), /*#__PURE__*/_react.default.createElement("div", {
    style: {
      flex: "1",
  ...
  }, children), /*#__PURE__*/_react.default.createElement(_material.Button, {
    variant: "contained",
    style: {
      borderRadius: 0,
