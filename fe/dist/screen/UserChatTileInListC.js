...
exports.default = UserChatTileInListC;
...
function UserChatTileInListC(_ref) {
  let {
    profiles,
    SetWithEmail,
    SetWithUserId,
  ...
  return /*#__PURE__*/_react.default.createElement("div", null, profiles && profiles.map(profile => /*#__PURE__*/_react.default.createElement("div", {
    key: profile.id,
    onClick: () => {
    ...
    item: true,
    xs: 3
  }, /*#__PURE__*/_react.default.createElement("div", null, "10:20 AM"), /*#__PURE__*/_react.default.createElement("div", null, /*#__PURE__*/_react.default.createElement("div", {
    style: {
