...
var _ChatWindowWS = _interopRequireDefault(require("./ChatWindowWS"));
...
var _ChatModal = _interopRequireDefault(require("../../screen/ChatModal"));
...
function ChatWS(_ref) {
  ...
  const [soc_conn, setsoc_conn] = (0, _react.useState)(null);
  ...
  return /*#__PURE__*/_react.default.createElement("div", null, /*#__PURE__*/_react.default.createElement(_Grid.default, {
    ...
    xs: 12,
    md: 7
  }, /*#__PURE__*/_react.default.createElement("div", null, with_userid ? /*#__PURE__*/
  // <ChatModal with_userid={with_userid} SetWithUserId={SetWithUserId} with_email={with_email}/>
  _react.default.createElement(_ChatWindowWS.default, {
    soc_conn: soc_conn,
    SetWithUserId: SetWithUserId,
    SetWithEmail: SetWithEmail,
  ...
  _react.default.createElement(_BlankChatScreen.default, null)))));
}
...
var _default = exports.default = (0, _reactRedux.connect)(mapStateToProps, null)(ChatWS);