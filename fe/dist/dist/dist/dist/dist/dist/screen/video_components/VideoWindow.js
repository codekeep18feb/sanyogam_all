...
var _VideoScreen = _interopRequireDefault(require("./VideoScreen"));
...
function VideoWindow(_ref) {
  ...
  const initializeWebRTC = async (token, type) => {
    if (type === "INITIATOR") {
      ...
      rc.setRemoteDescription(offer).then(a => {
        ...
        console.log("Signaling State after setting remoteDescription", rc.signalingState, a);
      });
  ...
  return /*#__PURE__*/_react.default.createElement("div", null, JSON.stringify(connection_open), /*#__PURE__*/_react.default.createElement("video", {
