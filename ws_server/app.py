...
CORS(app, resources={r"/*": {"origins": ["http://192.168.184.35:3000", "http://192.168.184.35:8000","http://192.168.184.35:8001"]}})
...
async def make_me_api_call(authorization_token):
    api_url = 'http://192.168.184.35:3000/api/me'
...
async def make_get_request_info_by_id_call(authorization_token,with_userid):
    api_url = 'http://192.168.184.35:8000/api/get_request_info_by_id/'+with_userid
...
async def make_all_profiles_api_call(authorization_token, request_data):
    api_url = 'http://192.168.184.35:3000/api/fetch_online_profiles'
