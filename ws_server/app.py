...
CORS(app, resources={r"/*": {"origins": ["http://192.168.1.10:3000", "http://192.168.1.10:8000","http://192.168.1.10:8001"]}})
...
async def make_get_request_info_by_id_call(authorization_token,with_userid):
    api_url = 'http://192.168.1.10:8000/api/get_request_info_by_id/'+with_userid
