...
def get_cors_origins(options, request_origin):
    ...
    # Terminate these steps, return the original request untouched.
        ...
        LOG.debug("The request did not contain an 'Origin' header. This means the browser or client did not request CORS, ensure the Origin HeaderDesktop is set.")
        return None
