...
# CORS(connex_app.app, resources={r"/api/*": {"origins": "http://192.168.1.11:3000"}})
CORS(connex_app.app, resources={r"/api/*": {"origins": ["http://192.168.1.11:3000", "http://192.168.1.11:8000"]}})
